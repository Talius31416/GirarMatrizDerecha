...
public class Main {
    public static void main(String[] args) {
        int filas = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese el numero de las filas: "));
        int columnas = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese el numero de las columnas: "));
